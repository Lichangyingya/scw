...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.getJSON(url1,arg,function (data) {
...
<div id="main">
    ...
    <div id="selectFrom">
        <form action="selStudentByCondition" method="get" id="formId">
    ...
    <span id="pageSpanId"><br>
         <a href="${pageContext.request.contextPath}/showStudent?pageNumber=1">&nbsp;&nbsp;首页</a>
         <c:if test="${pageInfo.pageNumber>1}">
             <a href="${pageContext.request.contextPath}/showStudent?pageNumber=${pageInfo.pageNumber-1}">&nbsp;上一页</a>
         </c:if>
         <c:if test="${pageInfo.pageNumber<pageInfo.totalPage}">
             <a href="${pageContext.request.contextPath}/showStudent?pageNumber=${pageInfo.pageNumber+1}">&nbsp;下一页</a>
         </c:if>
        <a href="${pageContext.request.contextPath}/showStudent?pageNumber=${pageInfo.totalPage}">&nbsp;尾页</a>
