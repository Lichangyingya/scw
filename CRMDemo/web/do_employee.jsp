...
<div id="addFrom">
    <form id="formId" action="updStaff" method="post" >
        <table width="400px" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="80px">登录名:</td>
                <td>
                    <input id="loginId" name="loginName" value="${staff.loginName}" onBlur="loginBlur()"/>
            ...
            <tr>
                <td>密码：</td>
                <td>
                    <input id="pwdId" name="pwd" value="${staff.loginPwd}" onBlur="pwdBlur()"/>
                    <span id="pwdTip"></span>
                </td>
            </tr>
            <tr>
                <td>姓名：</td>
                <td>
                    <input id="userId" name="userName" value="${staff.staffName}" onBlur="userNameBlur()"/>
            ...
            <tr>
                ...
                <td>
                    <input id="postTime" type="date"
                           value="${staff.onDutyDateStr}" name="PostTime" onBlur="timeBlur()"/>
