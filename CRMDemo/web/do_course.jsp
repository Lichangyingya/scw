...
<div id="addFrom">
    <form id="formId" action="updateLesson" method="post" >
        <table width="500px" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="80px">课程名称:</td>
                <td>
                    <input type="hidden" name="id" value="${lesson.id}">
                    <input id="couseId" name="lessonName" value="${lesson.lessonName}" onBlur="couseNameBlur()"/>
            ...
            <tr>
                <td>课程费用:</td>
                <td>
                    <input id="couseMoney" type="number" value="${lesson.lessonCost}" name="lessonCost" onBlur="moneyBlur()"/>
            ...
            <tr>
                <td>总学时:</td>
                <td>
                    <input id="classHour" type="number" value="${lesson.totalTime}" name="totalTime" onBlur="chourBlur()"/>
            ...
            <tr>
                <td>课程简介:</td>
                <td>
                    <textarea rows="10" cols="40" name="remark">${lesson.remark}</textarea>
                </td>
            </tr>
        </table>
    </form>
