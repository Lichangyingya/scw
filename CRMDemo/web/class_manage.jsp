...
<div id="dataArea">
    ...
    <table class="dataTable" width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr class="hbg">
            ...
            <th width="50px" align="center">课表</th>
            th
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            ...
            <td align="center">
                <a href="${pageContext.request.contextPath}/selClassVo?id=${classVo.id}" target="mainframe">上传</a>
                <a href="${pageContext.request.contextPath}/downloadCourse?id=${classVo.id}">下载</a>
            </td>
        </tr>
        </c:forEach>
    </table>
...
<div id="pageDiv">
    <span id="pageSpanId">
       <a href="${pageContext.request.contextPath}/showClass?pageNumber=1">&nbsp;&nbsp;首页</a>
         <c:if test="${pageInfo.pageNumber>1}">
             <a href="${pageContext.request.contextPath}/showClass?pageNumber=${pageInfo.pageNumber-1}">&nbsp;上一页</a>
         </c:if>
         <c:if test="${pageInfo.pageNumber<pageInfo.totalPage}">
             <a href="${pageContext.request.contextPath}/showClass?pageNumber=${pageInfo.pageNumber+1}">&nbsp;下一页</a>
         </c:if>
        <a href="${pageContext.request.contextPath}/showClass?pageNumber=${pageInfo.totalPage}">&nbsp;尾页</a>
